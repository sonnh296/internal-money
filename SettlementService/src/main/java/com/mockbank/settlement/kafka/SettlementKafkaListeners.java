package com.mockbank.settlement.kafka;

import com.mockbank.commons.dto.billpay.Pain002FileMessage;
import com.mockbank.commons.dto.events.billpay.BillBatchReadyEvent;
...
import com.mockbank.settlement.service.SettlementProcessor;
...
public class SettlementKafkaListeners {
     ...
     * Áp dụng cho tất cả @KafkaListener trong class này.
     */
    @DltHandler
    public void handleDlt(String message, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic) {
        log.error("DLT [SettlementKafkaListeners]: message không xử lý được sau tất cả lần retry. topic={} payload={}",
            topic, message);
    }
}
