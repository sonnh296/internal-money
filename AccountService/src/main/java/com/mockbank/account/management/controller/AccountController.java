package com.mockbank.account.management.controller;

import com.mockbank.commons.dto.account.AccountBalanceResponse;
import com.mockbank.commons.dto.account.AccountLookupResponse;
...
import com.mockbank.commons.dto.account.InternalTransferResponse;
import com.mockbank.commons.dto.account.PostingRequest;
import com.mockbank.commons.dto.account.ProvisionAccountRequest;
import com.mockbank.account.management.service.AccountService;
...
public class AccountController {
    ...
    public ResponseEntity<HoldResponse> placeHold(
        ...
        if (idempotencyKey == null || idempotencyKey.isBlank()) {
            throw new com.mockbank.commons.dto.exception.BadRequestException("Idempotency-Key là bắt buộc khi đặt hold");
        }
    ...
    public ResponseEntity<AccountResponse> credit(
            ...
            @Valid @RequestBody PostingRequest request) {
        if (idempotencyKey == null || idempotencyKey.isBlank()) {
            throw new com.mockbank.commons.dto.exception.BadRequestException("Idempotency-Key là bắt buộc cho credit");
        }
    ...
    public ResponseEntity<AccountResponse> debit(
            ...
            @Valid @RequestBody PostingRequest request) {
        if (idempotencyKey == null || idempotencyKey.isBlank()) {
            throw new com.mockbank.commons.dto.exception.BadRequestException("Idempotency-Key là bắt buộc cho debit");
        }
        Integer expected = parseIfMatch(ifMatch);
    ...
    public ResponseEntity<InternalTransferResponse> transfer(
        ...
        if (idempotencyKey == null || idempotencyKey.isBlank()) {
            throw new com.mockbank.commons.dto.exception.BadRequestException("Idempotency-Key là bắt buộc cho chuyển khoản");
        }
