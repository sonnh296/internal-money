...
package com.mockbank.account.transaction.controller;
...
import com.mockbank.account.transaction.service.TransactionService;
...
public class TransactionController {
    ...
    private static final String UUID_PATH = "[0-9a-fA-F\\-]{36}";
    ...
    @GetMapping("/transactions/{transactionId:" + UUID_PATH + "}")
    @PreAuthorize("hasAuthority('SCOPE_fdx:transactions.read')")
