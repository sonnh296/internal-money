...
import com.mockbank.account.model.AccountHold;
...
class AccountServiceHoldConcurrencyTest {
    ...
    void setUp() {
        ...
        when(transactionMapper.toEntity(any())).thenReturn(com.mockbank.account.model.Transaction.builder().build());
        ...
        service = new AccountService(
                ...
                transactionService,
                transactionMapper,
                Mockito.mock(com.mockbank.account.client.CustomerServiceClient.class),
