...
class AccountServiceTransferTest {
    ...
    void creditIdempotencyReplayShouldReturnCurrentBalanceFromDatabase() {
        ...
        Account account = Account.builder()
                ...
                .status(AccountStatus.ACTIVE)
                .build();
        com.account.model.Transaction existing = com.account.model.Transaction.builder()
        ...
        var response = service.credit(accountId, new com.account.dto.PostingRequest(new BigDecimal("20.00"), "test"),
                null, "credit-idem-1");
    ...
    void debitIdempotencyReplayShouldReturnCurrentBalanceFromDatabase() {
        ...
        var response = service.debit(accountId, new com.account.dto.PostingRequest(new BigDecimal("20.00"), "test"),
                null, "debit-idem-1");
