package com.mockbank.commons.observability.autoconfig;

import com.mockbank.commons.observability.web.CorrelationAndAccessLogFilter;
...
public class WebLoggingAutoConfiguration {
  ...
  static class FeignCidConfig {
    ...
    public feign.RequestInterceptor cidFeignInterceptor() {
      return new com.mockbank.commons.observability.http.CidFeignInterceptor();
    }
  }
}
