...
public class Payment {
  ...
  /** Điểm redeem — chỉ áp dụng khi payment POSTED, không redeem lúc accept */
  @Column(name="points_to_redeem", nullable=false)
  private Long pointsToRedeem = 0L;

  /** Optimistic lock: tránh lost update khi nhiều Kafka consumer xử lý cùng payment */
